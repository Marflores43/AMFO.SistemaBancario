...
namespace AMFO.Uninter.SistemaBancario
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // --- 3. CREACIÓN DE 3 OBJETOS CUENTA ---
            Cuenta cuenta1 = new Cuenta("CTA-1001", 15400.50m, "Débito", DateTime.Now.AddYears(-2));
            Cuenta cuenta2 = new Cuenta("CTA-1002", 8500.00m, "Ahorro", DateTime.Now.AddYears(-1));
            Cuenta cuenta3 = new Cuenta("CTA-1003", 32000.75m, "Débito", DateTime.Now.AddMonths(-6));
    ...
    public class Banco
    {
        ...
        {
            Cuenta nuevaCuenta = new Cuenta("CTA-NUEVA", 0.0m, "Débito", DateTime.Now);
